...
export const EnlacesNavegacionTopMenu = [{ section: "Menú", ruta: "/menu" }, { section: "Servicios", ruta: "/servicios" }, { section: "Galería", ruta: "/galeria" }, { section: "Contacto", ruta: "contacto" }];
export const Color_Letra_secciones = "#b23a48";
...
export const Color_Circulo_Numero_Iconos = "bg-[#df2935] text-[#f2f2f2]"
...
export const Color_Circulo_Numero_Iconos_Mobile = "bg-[#df2935] text-[#f2f2f2]";
